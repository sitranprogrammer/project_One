      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          {{ Request::is('quan-tri/danh-muc-cap-2') ? 'menu-open' :null}}">
            ...
            {{ Request::is('quan-tri/danh-muc-cap-2') ? 'active' :null}}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('danh-muc-cap-1.index')}}" class="nav-link {{ Request::is('quan-tri/danh-muc-cap-1') ? 'active' :null}}
                {{ Request::is('quan-tri/danh-muc-cap-1/create') ? 'active' :null}}">
              ...
              <li class="nav-item">
                <a href="{{route('danh-muc-cap-2.index')}}" class="nav-link {{ Request::is('quan-tri/danh-muc-cap-2') ? 'active' :null}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh Mục Cấp 2</p>
                </a>
              </li>
